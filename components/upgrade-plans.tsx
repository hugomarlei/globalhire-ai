  ...
  return (
    <section className="grid gap-4">
        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xl font-semibold text-foreground">ATS Score estimado</h3>
            </div>
          ...
          <Card key={plan.id} className={`flex h-full flex-col ${plan.id === "pro" ? "border-brand-500/60" : ""}`}>
            <div>
              <div className="flex items-center justify-between gap-3">
                ...
                {currentPlan === plan.id ? <span className="rounded-full bg-muted px-3 py-1 text-xs font-semibold text-muted-foreground">Plano atual</span> : null}
              </div>
      ...
      <p className="text-xs leading-5 text-muted-foreground">
        Ao assinar, você concorda com os <Link href="/termos" className="text-muted-foreground underline-offset-2 hover:text-foreground">Termos de Uso</Link>, a{" "}
        <Link href="/privacidade" className="text-muted-foreground underline-offset-2 hover:text-foreground">Política de Privacidade</Link> e a{" "}
        <Link href="/refund-policy" className="text-muted-foreground underline-offset-2 hover:text-foreground">Política de Cancelamento e Reembolso</Link>. Pagamentos são processados pelo Stripe.
      </p>
    </section>
  );
}
