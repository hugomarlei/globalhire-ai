...
export const landingCopy: Record<Locale, {
  ...
  "pt-BR": {
    eyebrow: "Workspace premium para candidatura internacional",
    headline: "Seu currículo precisa fazer sentido antes do recrutador chegar nele.",
    subheadline:
      "A GlobalHire organiza currículo, contexto da vaga e exportação em um fluxo guiado para deixar cada candidatura mais clara, mais específica e mais fácil de revisar.",
    primaryCta: "Criar currículo grátis",
    secondaryCta: "Ver planos",
    previewItems: ["Base factual", "Ajuste por vaga", "Exportação pronta", "Histórico visível"],
    previewLabel: "Workspace",
    previewText: "Currículo central, score visível e próximas ações claras em um fluxo premium.",
    featureCards: [
      { title: "Dor real", text: "Currículos bons perdem força quando viram texto genérico, sem foco na vaga, no país ou no mercado." },
      { title: "Solução prática", text: "A plataforma guia a adaptação do documento, prioriza o que importa e entrega saídas alinhadas ao contexto." },
      { title: "Controle honesto", text: "Você vê progresso, score e histórico sem promessas irreais de entrevista, aprovação ou contratação." }
    ],
    howItWorks: "Jornada guiada",
    steps: [
      { title: "Currículo base", text: "Comece com o que você já tem, sem apagar sua história." },
      { title: "Vaga-alvo", text: "Insira a descrição da vaga para orientar a adaptação." },
      { title: "Revisão e exportação", text: "Confira score, ajuste o que precisar e exporte com segurança." },
      { title: "Acompanhamento", text: "Salve o resultado e veja seu histórico no mesmo workspace." }
    ],
    benefitsTitle: "Benefícios reais",
    benefits: [
      "Currículo centrado no documento",
      "ATS Score visível antes de aplicar",
      "Reescrita contextual por vaga",
      "Saídas para carta, LinkedIn e mensagens",
      "Histórico e exportação no mesmo fluxo",
      "Adaptação por idioma e país"
    ],
    pricingTitle: "Planos que acompanham seu ritmo",
    scoreTitle: "Antes e depois da revisão",
    scoreText: "Veja a diferença de clareza, foco e aderência antes de exportar.",
    freePlan: "Grátis",
    paidPlan: "Pro/Elite",
    startNow: "Começar agora",
    faqTitle: "Perguntas frequentes",
    faqs: [
      ["A GlobalHire garante entrevista ou emprego?", "Não. A plataforma melhora clareza, aderência e estrutura, mas nenhuma ferramenta pode garantir entrevista, aprovação ou contratação."],
      ["Meus dados profissionais são usados pela IA?", "Sim, apenas para processar a solicitação que você faz, como otimizar currículo ou gerar carta. Evite enviar dados sensíveis desnecessários."],
      ...
      ["Qual plano devo começar?", "O Free permite uma degustação premium. O Starter é bom para uso pontual, Pro para candidaturas recorrentes e Elite para otimização avançada."]
    ],
    finalCtaTitle: "Pronto para transformar a próxima candidatura?",
    ...
    honestyLine: "Melhora aderência e clareza. Sem prometer entrevista, emprego ou aprovação automática.",
    truthCards: [
      ["O problema", "Muitos currículos perdem força porque viram texto genérico, sem contexto de vaga, país ou mercado."],
      ["A solução", "A IA reorganiza fatos, posicionamento e palavras-chave para cada candidatura, com mais foco e clareza."],
    ...
    pricingLead: "Escolha o plano conforme seu ritmo. Os valores abaixo são os oficiais da plataforma.",
    planCta: "Selecionar plano",
    recommendedBadge: "Mais usado",
    stats: [
      ["1", "currículo central"],
      ["6", "ferramentas integradas"],
      ["3", "idiomas disponíveis"]
    ],
    scoreMockLabel: "Comparativo antes / depois",
    scoreMockSubtitle: "O currículo fica mais específico",
    scoreBefore: "Antes da revisão",
    scoreAfter: "Depois da revisão",
    scoreHintTitle: "Exemplo de melhoria",
    scoreHintBody:
      "Antes: \"Responsável por relatórios e reuniões.\" Depois: \"Conduziu análises de desempenho, priorizou indicadores de receita e apoiou decisões executivas com base em dados.\"",
    finalCtaButton: "Começar grátis",
    pricingDisclaimer: "Valores oficiais em BRL.",
    heroTagline: "Fluxo guiado · currículo, score e exportação em um só workspace",
    pricingSectionTitle: "Planos claros para crescer no ritmo certo",
    howItWorksCards: [
